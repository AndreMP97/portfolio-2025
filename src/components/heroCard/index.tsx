...
export const HeroCard: React.FC<THeroCardProps> = ({
  ...
  return (
    <motion.div
      ...
      {...motionProps}
      className="border-aqua-mint bg-midnight-navy relative flex flex-col items-center justify-center gap-8 overflow-hidden rounded-2xl border-2 p-6 shadow-2xl md:flex-row md:gap-12 md:p-8 lg:gap-16 lg:p-10"
    >
      <motion.div
